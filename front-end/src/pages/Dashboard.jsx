      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <div className="bg-white border border-green-100 rounded-xl shadow p-4 flex flex-col items-center">
            ...
            <span className="mt-1 text-green-600 font-semibold text-sm sm:text-base">Toutes les taches</span>
          </div>
          <div className="bg-white border border-green-100 rounded-xl shadow p-4 flex flex-col items-center">
          ...
          <div className="bg-white border border-green-100 rounded-xl shadow p-4 flex flex-col items-center">
            ...
            <span className="mt-1 text-green-600 font-semibold text-sm sm:text-base">Taches partagées</span>
          </div>
        </div>
        <div className="flex flex-col gap-4">
          <div className="bg-green-50 rounded-xl shadow p-4">
            ...
            <p className="text-green-900 text-sm">Gérez vos tâches, consultez les utilisateurs et partagez vos taches.</p>
          </div>
          <div className="flex gap-2 justify-center mt-2">
            <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-xl shadow transition-all text-sm" onClick={() => navigate('/todos')}>Voir mes taches</button>
